...
> Status: SPOS-014 baseline; Constitution, Governance, Developer Mode, Session, Execution, Git, Documentation, Quality, Report, Master Prompt System, Master Integration System, dan Master Workflow System `In Review`; Master Knowledge System menjadi dependency Foundation `In Review`, dan architecture tetap Draft sampai authority yang sah mengaktifkannya.
...
- [`MASTER_INTEGRATION_SYSTEM.md`](MASTER_INTEGRATION_SYSTEM.md) — integration control map untuk relationship, dependency, authority, interface, knowledge/prompt/documentation/governance/session/execution/validation/report mapping, information/decision/traceability flow, lifecycle, versioning, security, quality, dan compatibility.
- [`MASTER_WORKFLOW_SYSTEM.md`](MASTER_WORKFLOW_SYSTEM.md) — kontrak orkestrasi dokumentatif untuk workflow architecture, layer, component, relationship, dependency, authority, lifecycle/state/transition, workflow domain, security, quality, governance, traceability, information/decision/escalation/rollback/conflict flow, Human Override, AI boundary, dan future compatibility.
...
Governance Engine menerjemahkan Constitution menjadi authority, ownership, decision, delegation, lifecycle governance, compliance, dan AI governance. Developer Mode menetapkan perilaku operasional AI; Session Engine menetapkan unit kerja, lifecycle orchestration, state, continuity, kewajiban report, dan closure; Execution Engine menetapkan prosedur eksekusi, checkpoint, recovery, evidence, serta completion criteria; Git Engine menetapkan workflow version control; Documentation Engine menetapkan tata kelola dokumentasi; Quality Engine menetapkan quality gate, DoD, metrik, audit kualitas, dan continuous improvement; Report Engine menetapkan taxonomy, lifecycle, struktur, evidence/traceability, validasi, koreksi, publication, archive, dan aggregation guardrail laporan; Master Prompt System menetapkan cara seluruh authority dan kontrak tersebut dirakit menjadi prompt package yang bounded; Master Integration System memetakan relationship, dependency, authority, interface, flow, compatibility, dan change propagation lintas sistem; Master Workflow System mengatur komposisi stage, gate, handoff, state/transition guardrail, dan end-to-end flow tanpa mengambil lifecycle atau semantics domain; Master Knowledge System menetapkan cara claim/evidence/provenance/context dikurasi dan dikonsumsi tanpa berubah menjadi instruction, decision, policy, atau approval otomatis. Seluruh engine mempertahankan ownership domain dan tidak dapat memberi approval kepada dirinya sendiri. Integration map tidak menjadi mega-policy, runtime, atau owner baru. Core tidak memiliki requirement produk; engine tambahan hanya dibuat melalui session terpisah dengan owner, status, dependency, dan review eksplisit.
