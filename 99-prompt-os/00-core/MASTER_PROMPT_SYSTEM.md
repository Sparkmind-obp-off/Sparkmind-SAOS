...
>
> Review trigger: amendment Constitution; perubahan Governance, Developer Mode, Session, Execution, Report, Documentation, Git, Quality, Foundation, Master Knowledge System, Master Integration System, Master Workflow System, SPOS Architecture, model/tool/capability, threat model, prompt injection finding, incident, evaluation failure, atau evidence prompt/knowledge/integration drift
...
| [`MASTER_WORKFLOW_SYSTEM.md`](MASTER_WORKFLOW_SYSTEM.md) | workflow stage/gate/handoff, lifecycle/state/transition separation, validation/review/approval, exception/escalation/rollback, dan end-to-end flow | Prompt package mengikuti workflow contract tanpa menjadi workflow runtime atau menggantikan Session/Execution semantics |
...
- [x] Constitution, Governance, Developer Mode, Session, Execution, Report, Documentation, Git, Quality, Foundation, Master Knowledge System/Knowledge Governance, Master Integration System, Master Workflow System, serta SPOS Architecture dipetakan tanpa SSOT tandingan.
