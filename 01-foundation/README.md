...
10. Workflow map hanya mengomposisikan stage, gate, handoff, serta flow; Foundation tetap memiliki semantics context, knowledge, decision, pattern, dan playbook domain.
