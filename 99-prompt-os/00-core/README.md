...
> Status: SPOS-011 baseline; Constitution, Governance, Developer Mode, Session, Execution, Git, Documentation, Quality, Report, dan Master Prompt System `In Review`, architecture tetap Draft sampai authority yang sah mengaktifkannya.
