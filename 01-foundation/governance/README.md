...
> Status: Struktur aktif; Constitution, Developer Mode, dan Execution Engine SPOS tersedia sebagai `In Review`, kebijakan governance substantif belum disusun.
...
- Menjadi authority operasional upstream bagi [`../../99-prompt-os/00-core/DEVELOPER_MODE_ENGINE.md`](../../99-prompt-os/00-core/DEVELOPER_MODE_ENGINE.md) dan [`../../99-prompt-os/00-core/EXECUTION_ENGINE.md`](../../99-prompt-os/00-core/EXECUTION_ENGINE.md); selama policy substantif belum tersedia, kasus authority ambigu wajib fail-closed dan dieskalasikan.
