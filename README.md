...
> Status repository: Foundation Architecture, Knowledge System, dan SPOS baseline terdokumentasi. Constitution SPOS-002, Developer Mode Engine SPOS-003, Execution Engine SPOS-004, serta Git Engine SPOS-005 berstatus `In Review`; Kernel Session 001 masih berupa kerangka terstruktur.
...
- Baseline SparkMind Prompt Operating System (SPOS) dengan Constitution Engine, Developer Mode Engine, Execution Engine, Git Engine, architecture, session framework, dan prompt templates.
...
- Approval operasional dan activation record Developer Mode, Execution Engine, serta Git Engine.
- Documentation, Quality, Session, Report, Governance, dan engine substantif SPOS lainnya.
...
5. Baca [`99-prompt-os/00-core/CONSTITUTION.md`](99-prompt-os/00-core/CONSTITUTION.md), [`99-prompt-os/00-core/DEVELOPER_MODE_ENGINE.md`](99-prompt-os/00-core/DEVELOPER_MODE_ENGINE.md), [`99-prompt-os/00-core/EXECUTION_ENGINE.md`](99-prompt-os/00-core/EXECUTION_ENGINE.md), [`99-prompt-os/00-core/GIT_ENGINE.md`](99-prompt-os/00-core/GIT_ENGINE.md), dan [`99-prompt-os/README.md`](99-prompt-os/README.md) sebelum menyusun workflow atau session AI; gunakan hanya artefak dengan status dan authority yang sesuai.
...
- **Status:** Foundation, Knowledge System, dan SPOS-005 baseline aktif sebagai dokumentasi; Constitution, Developer Mode, Execution Engine, serta Git Engine menunggu approval yang sah dan repository belum berupa aplikasi.
